...
export const Phase5p4 = () => {
    ...
    const question = 'Do you want a fish or a bird?';
    ...
    async function handleDragEnd({ active, over }) {
        ...
        if (draggedCard) {
            if (draggedCard.id === 'fish' || draggedCard.id === 'bird') {
                ...
                setIncorrect(true);
                await onSound("The question is 'do you want a fish or a bird. Please try again!");
                return;
            }
    ...
    return (
        <div className="container-phase">
            {isContinue && <button className='button-continue' onClick={() => navigate('/phase6p1')}> Continue </button>}
                            ...
                            .map(c => (
                                <DraggableCard
                                    ...
                                    style={{
                                        ...
                                        top: `${c.pos.yPct}%`,
                                        position: 'absolute',
                                        outline: (incorrect && (c.id === 'fish' || c.id === 'bird')) ? '3px solid red' : 'none',
                                        outlineOffset: (incorrect && (c.id === 'fish' || c.id === 'bird')) ? '3px' : '0',
                                        backgroundColor: (incorrect && (c.id === 'fish' || c.id === 'bird')) ? 'rgba(255,0,0,0.15)' : 'transparent',
                                        boxShadow: (incorrect && (c.id === 'fish' || c.id === 'bird')) ? '0 0 12px 4px rgba(255,0,0,0.6)' : 'none',
                                        borderRadius: '8px',
                                    }}
